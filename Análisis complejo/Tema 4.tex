...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item Veamos que $F(D) = \mathbb{D}$.
              ...
              $$S_a'(z) = \frac{1-\overline{a}z + (z-a)\overline{a}}{(1-\overline{a}z)^2} = \frac{1-|a|^2}{(1-\overline{a}z)^2}.$$
              ...
              Luego $|g(z_0)|^2 = |h(z_0)|$ y también $2|g(z_0)||g'(z_0)| = |h'(z_0)|$.
              Entonces:
              ...
              Por tanto, tenemos que $|G'(z_0)| > M$, con $G \in \mathcal{F}$ y $M = \sup_{f \in \mathcal{F}} |f'(z_0)|$, luego llegamos a contradicción.
