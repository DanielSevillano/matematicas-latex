...
Definimos:
\begin{align*}
    T_a(z) & = \frac{z+a}{1 + \bar{a}z}, \quad T_a \in \mathcal{M}, \; T_a(\mathbb{D}) = \mathbb{D}, \; T_a(0) = a, \\
    S_b(z) & = \frac{z-b}{1 - \bar{b}z}, \quad S_b \in \mathcal{M}, \; S_b(\mathbb{D}) = \mathbb{D}, \; S_b(b) = 0.
\end{align*}
...
\begin{enumerate}
    ...
    \item Por la regla de la cadena, $\varphi'(0) = T_a'(0) f'(a) S_b'(b)$.
          \begin{align*}
              T_a'(z) & = \frac{1 + \bar{a}z - (z+a)\bar{a}}{(1 + \bar{a}z)^2}, \quad T_a'(0) = 1 - |a|^2,                                     \\
              S_b'(z) & = \frac{1 - \bar{b}z + (z-b)\bar{b}}{(1 - \bar{b}z)^2}, \quad S_b'(b) = \frac{1-|b|^2}{(1-|b|^2)} = \frac{1}{1-|b|^2}.
          \end{align*}
...
$$S_a(0) = -a, \quad S_a(a) = 0, \quad S_a\left(\frac{1}{\bar{a}}\right) = \infty.$$
