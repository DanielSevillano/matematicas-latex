...
\begin{example}
    ...
    \begin{center}
        \begin{tikzpicture}
            \begin{axis}[axis lines = middle, ymax = 1]
                \addplot [
                    domain = -1:0,
                    samples = 2,
                    color = red,
                ...
                \addplot[color = red, mark = *] coordinates { (4, 3/8) };
                ...
                \addplot[color = red, mark = *] coordinates { (5, 3/4) };
...
\begin{exercise}
    ...
    Por tanto, $S_Z = [-1, 5]$.
    Calculamos:
    $$F_Z(z) = \int_{-\infty}^\infty F_Y(z-x)dF_x(x) = \int_{-1}^1 F_Y(z-x)f_X(x)dx + F_Y(z-1)p_X(1)$$
    Consideramos los casos:
    \begin{itemize}
        \item Si $z < -1$, $F_Z(z) = 0$.
...
\begin{example}
    ...
    \begin{center}
        \begin{tikzpicture}
            \begin{axis}[
                    title = {Gráfica para $n = 2$},
                    axis lines = middle,
                    ymax = 1,
                    extra x ticks = {1/2}, extra x tick label = {$\frac{1}{n}$}
                ]
                ...
                \addplot[color = red, mark = *] coordinates { (1/2, 1) };
    ...
    \begin{center}
        \begin{tikzpicture}
            \begin{axis}[
                    ...
                    axis lines = middle,
                    ymax = 1,
                    extra x ticks = {-1/2, 1/2}, extra x tick labels = {$-\frac{1}{n}$, $\frac{1}{n}$}
                ]
    ...
    \begin{center}
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[color = red, mark = *] coordinates { (0, 1/2) };
...
\begin{example}
    ...
    \begin{align*}
        E(g(X_n)) & = E(I_{(0,2]}(X_n)) = \int_\mathbb{R} I_{(0,2]}(x) dF_n(x) = \int_0^2 dF_n(x) = F_n(2) - F_n(0) = \frac{3}{4} - \frac{1}{2n} \xrightarrow[n \to \infty]{} \frac{3}{4} \\
...
\begin{exercise}
    ...
    \begin{align*}
        F_n(x) & = P(X_n^{-1}((-\infty,x])) = P(X_n^{-1}([0,x])) = P(X_n^{-1}([0,e^{-nk}])) = P(\{ \omega \in \Omega : \omega \geq k \}) =               \\
               & = 1 - P(\{ \omega \in \Omega : \omega < k \}) = 1 - \sum_{\omega=0}^{k-1} e^{-\lambda}\frac{\lambda^\omega}{\omega!} =                  \\
               & = \begin{cases}
                       0                                                                    & \text{si } x <= 0                                              \\
